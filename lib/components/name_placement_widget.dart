...
class NamePlacementWidget extends StatefulWidget {
  const NamePlacementWidget({
    Key key,
    this.userProfile,
  }) : super(key: key);
  ...
  @override
  _NamePlacementWidgetState createState() => _NamePlacementWidgetState();
}

class _NamePlacementWidgetState extends State<NamePlacementWidget>
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(0, 8, 0, 0),
                          child: Text(
                            'Fill out the information below in order to place your name to be added to the collection list.',
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Mother Vs Father Information',
                        labelStyle: FlutterFlowTheme.bodyText1,
                        enabledBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                            color: FlutterFlowTheme.background,
